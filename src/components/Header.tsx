...
export default function Header({ externalClocks, onAddClock, onRemoveClock, onMCPSettings, mcpCount }: Props) {
  return (
    ...
    >
      ...
      >
        <img src="/Executive_logo_white_xx.png" alt="N4" style={{ height: 28, marginRight: 10, marginLeft: -3, flexShrink: 0, objectFit: 'contain', imageRendering: 'auto', WebkitFontSmoothing: 'antialiased' }} />
        <span style={{
          fontSize: 10,
          fontWeight: 500,
          letterSpacing: 2,
