...
export default function Header({ externalClocks, onAddClock, onRemoveClock, onMCPSettings, mcpCount }: Props) {
  return (
    ...
    >
      ...
      >
        <img src="/noBgWhite_(1).png" alt="N4" style={{ height: 46, marginRight: 10, marginLeft: -3, flexShrink: 0, objectFit: 'contain', imageRendering: 'auto', WebkitFontSmoothing: 'antialiased' }} />
        <span style={{
          fontSize: 10,
          fontWeight: 500,
          letterSpacing: 2,
