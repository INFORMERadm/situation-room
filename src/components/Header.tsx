...
export default function Header({ externalClocks, onAddClock, onRemoveClock, onMCPSettings, mcpCount }: Props) {
  return (
    ...
    >
      ...
      >
        <img src="/new_with_d_cropped.png" alt="DataDesk" style={{ height: 30, marginLeft: -3, flexShrink: 0, objectFit: 'contain', imageRendering: 'auto', WebkitFontSmoothing: 'antialiased' }} />
        <span style={{
          fontSize: 10,
          fontWeight: 500,
          letterSpacing: 2,
